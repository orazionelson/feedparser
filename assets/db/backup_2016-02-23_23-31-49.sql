...
INSERT INTO `cms_feedreader_config` (`id`, `flimit`, `cache_dir`, `cache_time`, `date_format`, `_created_at`, `_updated_at`, `_created_by`, `_updated_by`) VALUES ('1', '5', 'modules/feedreader/feedcache', '3600', 'd/m/y', NULL, NULL, NULL, NULL);
