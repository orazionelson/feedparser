...
/**
 * Description of Manage_feedreader_sources
 *
 * @author No-CMS Module Generator
 */
class Manage_feedreader_sources extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'feedreader_sources';
    protected $COLUMN_NAMES = array('url');
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Feeds');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('url');
        //$crud->edit_fields('url', '_updated_by', '_updated_at');
        //$crud->add_fields('url', '_created_by', '_created_at');
        //$crud->set_read_fields('url');

        // caption of each columns
        $crud->display_as('url','Feed url');
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $crud->set_rules('url', 'Feed url', 'valid_url');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_feedreader_sources_view', $output,
            $this->n('manage_feedreader_sources'), $config);
    }
