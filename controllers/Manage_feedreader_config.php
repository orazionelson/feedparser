...
/**
 * Description of Manage_feedreader_config
 *
 * @author No-CMS Module Generator
 */
class Manage_feedreader_config extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'feedreader_config';
    protected $COLUMN_NAMES = array('flimit', 'cache_dir', 'cache_time', 'date_format');
    ...
    protected $UNSET_BACK_TO_LIST = TRUE;
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Feed Reader Configuration');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('flimit', 'cache_dir', 'cache_time', 'date_format');
        //$crud->edit_fields('flimit', 'cache_dir', 'cache_time', 'date_format', '_updated_by', '_updated_at');
        //$crud->add_fields('flimit', 'cache_dir', 'cache_time', 'date_format', '_created_by', '_created_at');
        //$crud->set_read_fields('flimit', 'cache_dir', 'cache_time', 'date_format');

        // caption of each columns
        $crud->display_as('flimit','Max num of items');
        $crud->display_as('cache_dir','Cache path');
        $crud->display_as('cache_time','Cache expiring time');
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $crud->set_rules('flimit', 'Max num of items', 'integer');
        $crud->set_rules('cache_time', 'Cache expiring time', 'integer');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_feedreader_config_view', $output,
            $this->n('manage_feedreader_config'), $config);
    }
